...
export default function AgendaHeroDay2({ data }) {
	return (
			...
			<div className='container'>
				...
				<div className='flex flex-wrap content'>
					<div className='basis-full lg:basis-9/12'>
						...
						<p className='text mb-[40px]'>{data.text}</p>

						<div className='flex flex-wrap items-center mb-[50px]'>
							<div className='basis-full md:basis-auto'>
								<StaticImage
									className='w-[55px] md:w-[65px] h-full mr-4'
									placeholder='none'
									quality={100}
									alt=''
									src={"../../images/sections/agenda/argus.png"}
								/>
							</div>
							<div className='zk-track basis-full md:basis-1/2'>{data.gameText}</div>
						</div>
						<div className='basis-full'>
							<div className='flex flex-col sm:items-center sm:flex-row'>
								...
								<div className='max-sm:mt-4 basis-auto'>
									<Button class={data.buttons.class} type={data.buttons.type} text={data.buttons.text} url={data.buttons.url} />
								</div>
							</div>
						</div>
					</div>
