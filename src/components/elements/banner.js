		...
		<div className='w-full mt-8 md:w-auto livestream-banner'>
			<div className='flex flex-col items-start justify-between lg:items-center lg:flex-row'>
				...
				<div className='flex items-center'>
					<a className='livestream-button group' href={link} target='_blank' rel='noreferrer'>
						<span className='filter animate' />
						<svg className="mr-3 z-[2] transition-transform group-hover:scale-[1.1] group-active:scale-[1]" xmlns='http://www.w3.org/2000/svg' width='25' height='25' viewBox='0 0 25 25' fill='none'>
