export const footerData = {
    ...
    text: "Join the official Modular Summit event and follow the official Twitter account to connect with attendees and learn about the latest speaker announcements and get access to early bird tickets.",
	button: {
		text: "Volunteer",
		class: "primary small",
		type: "external",
		url: "https://celestia-intake.typeform.com/to/g5SBXBOV",
	},
    social: {
        // discord: "/",
        // github: "/",
